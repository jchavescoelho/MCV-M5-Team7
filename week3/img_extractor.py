...
# Best configuration: Retina Net + 0.001 lr + all data + 256 regions -> 83.38 AP50
...
eval_name = f'{dts}_{model[15:-5]}_imgextractor'

os.makedirs(f'./output_eval_imgextractor/{eval_name}', exist_ok=True)
evaluator = COCOEvaluator(dts, ("bbox", ), False, output_dir=f'./output_eval_imgextractor/{eval_name}')
